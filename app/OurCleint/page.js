...
export default function OurClient() {
  return (
    <div className="our-client" id="client">
      <div className="main-ourCon">
        <h1> OUR CLIENTS</h1>
        <div className="our-clientContent">
          <svg
            preserveAspectRatio="xMidYMid meet"
            data-bbox="40.4 65 128.913 69"
            viewBox="40.4 65 128.913 69"
            height="200"
            width="200"
          ...
          >
            <g>
              ...
              ></path>
              <path
                d="M69.3 111.3c0-.2-.3-.4-1-.4.1.3.2.5.3.8h.1c.3 0 .6-.1.6-.4z"
                fill="#000001"
                data-color="1"
              ></path>
              <path
          ...
          <svg
            preserveAspectRatio="xMidYMid meet"
            data-bbox="58.7 82.2 92.6 31.6"
            viewBox="58.7 82.2 92.6 31.6"
            height="200"
            width="200"
            xmlns="http://www.w3.org/2000/svg"
            data-type="color"
          ...
          >
            <g>
              ...
              <path
                fill="#000001"
                d="M151.3 92.8v3.3h-25.1v-3.3h25.1z"
                data-color="1"
              ></path>
              <path
                fill="#000001"
                d="M151.2 99.3v3.3h-16.7v-3.3h16.7z"
                data-color="1"
              ></path>
            </g>
          </svg>
          <svg
            preserveAspectRatio="xMidYMid meet"
            data-bbox="36.3 78.9 128.7 31.4"
            viewBox="36.3 78.9 128.7 31.4"
            height="200"
            width="200"
            xmlns="http://www.w3.org/2000/svg"
            data-type="shape"
          ...
          <svg
            preserveAspectRatio="xMidYMid meet"
            data-bbox="65.7 67.9 73.3 63"
            viewBox="65.7 67.9 73.3 63"
            height="200"
            width="200"
            xmlns="http://www.w3.org/2000/svg"
            data-type="color"
          ...
          >
            <g>
              ...
              ></path>
              <path
                d="M86 130.6v-19.3h13.1v3.7h-8.9v3.9h7.6v3.7h-7.6v4.2h8.9v3.7H86z"
                fill="#000001"
                data-color="1"
              ></path>
              <path
